...
def get_graph_manager(hp_dict, agent_list, run_phase_subject):
    ...
    params["exploration_type"] = (hp_dict.get(
        "exploration_type", "categorical")).lower()
    ...
    params["loss_type"] = hp_dict.get(
        "loss_type", "Mean squared error").lower()
    ...
    vis_params = VisualizationParameters(dump_mp4=False, tensorboard=True)
