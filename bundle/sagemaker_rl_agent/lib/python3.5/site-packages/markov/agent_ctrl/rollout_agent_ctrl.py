...
class RolloutCtrl(AgentCtrlInterface, ObserverInterface):
    ...
    def _get_car_start_model_state(self, start_dist):
        ...
        target_x, target_y = self._reward_.compute_respawn_target(self._track_data_.inner_border.coords, self._track_data_.get_way_pnts(), self._track_data_.outer_border.coords, next_wp_idx, self._reverse_dir_)
